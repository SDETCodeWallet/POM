...
public class Login_Page extends UI_GenericMethods {
	...
	public static NewCustomer_Page fn_navigateToNewCustomerPage(){

  		NewCustomer_Page newCustomerObj = PageFactory.initElements(DriverObject, NewCustomer_Page.class);
